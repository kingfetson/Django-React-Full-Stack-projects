...
export default function CustomerLayout({ children, title }: CustomerLayoutProps) {
  ...
  const menuItems = [
    { icon: "📊", label: "Dashboard", href: "/customer" },
    { icon: "📦", label: "My Orders", href: "/customer/orders" },
    { icon: "❤️", label: "Wishlist", href: "/customer/wishlist" },
    { icon: "📍", label: "Addresses", href: "/customer/addresses" },
    { icon: "👤", label: "Profile", href: "/customer/profile" },
    { icon: "🔒", label: "Security", href: "/customer/security" },
  ];
