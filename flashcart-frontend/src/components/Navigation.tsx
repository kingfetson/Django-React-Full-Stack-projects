...
export default function Navigation() {
  ...
  // Don't render user-dependent content until after mounting to prevent hydration mismatch
  if (!isMounted) {
    // Return a minimal version that matches server rendering
    return (
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
              <Link href="/" className="text-white hover:text-orange-100 transition-colors font-medium">Home</Link>
              <Link href="/contact" className="text-white hover:text-orange-100 transition-colors font-medium">Contact</Link>
              <div className="w-24 h-10 bg-orange-500 rounded-lg animate-pulse"></div>
            </div>
